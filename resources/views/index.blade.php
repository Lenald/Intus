...
<html lang="en">
    ...
    <body>
        ...
        <form id="form" action="/save">
            ...
            <input type="submit" value="Make It Shorten">
        </form>

        <div id="result">
            <div class="row">
                <span id="link">http://localhost/ABCDEF</span>
                <button id="copy">
                    <svg fill="#000000" width="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
